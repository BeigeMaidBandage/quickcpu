...
- Tune CPU core parking and priority rules
- Monitor temps, clocks, and power limits
- Custom fan curves for quieter cooling
- Prevent background apps from stealing FPS
- Profiles for gaming vs productivity
